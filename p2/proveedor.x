...
program PROVEEDOR_PROG {
    version PROVEEDOR_VERS {
		void IMPRIMIR_INVENTARIO(void) = 1;				/* procedimiento numero = 1*/
		void INICIALIZAR_TABLA_PRODUCTOS(void) = 2;     /* procedimiento numero = 2*/
		void ACTUALIZAR_INVENTARIO(void) = 3;			/* procedimiento numero = 3*/
